...
For our project, we intend to do an animation of an object (Train) Rides along a track from the
left side of the screen to the right side of the screen and then vanishes and reappears on the left
side of the screen again in a loop. The Train animation will include moving clouds and also a
moving bird will transition from the right side of the screen to the left side of the screen. The
scene will also transition from day to night as the train is moving from the left side of the screen
to the right.
...
#define SPEED 1000.0 //train speed
...
if(plane==1)
{
	...
	glVertex2f(925+n,640+o);
	glVertex2f(950+n,655+o);
	glVertex2f(1015+n,655+o);
	glVertex2f(1030+n,660+o);
	glVertex2f(1050+n,660+o);
	glVertex2f(1010+n,640+o);
glEnd();

glColor3f(0.8,0.8,0.8);
	glBegin(GL_POLYGON);//wing 1
	glVertex2f(950+n,650+o);
	glVertex2f(1015+n,650+o);
	glVertex2f(1030+n,640+o);
	glVertex2f(1050+n,630+o);
glEnd();

glColor3f(0.8,0.8,0.8);
	glBegin(GL_POLYGON);//wing 2
	glVertex2f(960+n,655+o);
	glVertex2f(980+n,660+o);
	glVertex2f(1015+n,665+o);
	glVertex2f(1010+n,655+o);
glEnd();

	
}

if(plane==1) //plain lights
{

	for(l=0;l<=1;l++)
	{
		glColor3f(1.0,0.0,0.0);
		draw_circle(1050+n,630+o,l);
		glColor3f(0.0,0.0,1.0);
		draw_circle(1015+n,665+o,l);
...
//railway station 
glColor3f(0.517059,0.164706,0.164706);
glBegin(GL_POLYGON);
glVertex2f(400,250);
glVertex2f(400,450);
glVertex2f(950,450);
...
//door
glColor3f(0.267059,0.164706,0.164706);
glBegin(GL_POLYGON);
glVertex2f(625,250);
glVertex2f(625,375);
glVertex2f(725,375);
...
glColor3f(1.0,1.0,1.0);
glBegin(GL_POLYGON);
glVertex2f(-610+i-xm,175); 
glVertex2f(-610+i-xm,250);
glVertex2f(-695+i-xm,250);
glVertex2f(-695+i-xm,175);
glEnd();


glBegin(GL_POLYGON);
glVertex2f(-710+i-xm,175); 
glVertex2f(-710+i-xm,250);
glVertex2f(-795+i-xm,250);
glVertex2f(-795+i-xm,175);
glEnd();

glBegin(GL_POLYGON);
glVertex2f(-810+i-xm,175); 
glVertex2f(-810+i-xm,250);
glVertex2f(-895+i-xm,250);
glVertex2f(-895+i-xm,175);
glEnd();

glBegin(GL_POLYGON);
glVertex2f(-910+i-xm,175); 
glVertex2f(-910+i-xm,250);
glVertex2f(-995+i-xm,250);
glVertex2f(-995+i-xm,175);
glEnd();
...
glColor3f(1.0,1.0,1.0);
glBegin(GL_POLYGON);
glVertex2f(-160+i-xm,175); 
glVertex2f(-160+i-xm,250);
glVertex2f(-245+i-xm,250);
glVertex2f(-245+i-xm,175);
glEnd();

glBegin(GL_POLYGON);
glVertex2f(-260+i-xm,175); 
glVertex2f(-260+i-xm,250);
glVertex2f(-345+i-xm,250);
glVertex2f(-345+i-xm,175);
glEnd();

glBegin(GL_POLYGON);
glVertex2f(-360+i-xm,175); 
glVertex2f(-360+i-xm,250);
glVertex2f(-445+i-xm,250);
glVertex2f(-445+i-xm,175);
glEnd();

glBegin(GL_POLYGON);
glVertex2f(-460+i-xm,175); 
glVertex2f(-460+i-xm,250);
glVertex2f(-545+i-xm,250);
glVertex2f(-545+i-xm,175);
glEnd();

//connecter

glColor3f(0.17, 0.13, 0.16);
glBegin(GL_POLYGON);
...
glVertex2f(285+i-xm,250);
glVertex2f(205+i-xm,250);
glVertex2f(205+i-xm,175);
glEnd();

glBegin(GL_POLYGON);
glVertex2f(185+i-xm,175); 
glVertex2f(185+i-xm,250);
glVertex2f(105+i-xm,250);
glVertex2f(105+i-xm,175);
glEnd();

glBegin(GL_POLYGON);
glVertex2f(85+i-xm,175); 
glVertex2f(85+i-xm,250);
glVertex2f(5+i-xm,250);
glVertex2f(5+i-xm,175);
glEnd();

glBegin(GL_POLYGON);
glVertex2f(-15+i-xm,175); 
glVertex2f(-15+i-xm,250);
glVertex2f(-95+i-xm,250);
glVertex2f(-95+i-xm,175);
glEnd();
